### 1 参考
#### 1.1 挑战内容
- https://github.com/codecrafters-io/build-your-own-git/blob/main/stage_descriptions/base-07-mg6.md
#### 1.2 资料
- [This forum post](https://forum.codecrafters.io/t/step-for-git-clone-implementing-the-git-protocol/4407)
	- 如何逐步实现这一点的建议
- Git 的[智能 HTTP 传输协议](https://www.git-scm.com/docs/http-protocol)
	- [gitprotocol-pack  git 协议包](https://git-scm.com/docs/gitprotocol-pack)
	-  [gitformat-pack](https://git-scm.com/docs/gitformat-pack)
	- [Unpacking Git packfiles  解压 Git 包文件](https://codewords.recurse.com/issues/three/unpacking-git-packfiles)
	- [Sneaky git number encoding  偷偷摸摸的 git 编号编码](https://medium.com/@concertdaw/sneaky-git-number-encoding-ddcc5db5329f)
