...
![](asserts/Pasted%20image%2020250522001729.png)
我们目前的实验仅针对I型虚拟化。
### Hypervisor支撑的资源对象层次
![](asserts/Pasted%20image%2020250522001750.png)
...
![](asserts/Pasted%20image%2020250522001818.png)
第二种绑定，绑定之后就不可以更换。
- 效率高，劣势就是vcpu数量受限
![](asserts/Pasted%20image%2020250522001845.png)
- 个人评价：虚拟机就很像普通系统，地址对物理页帧的抽象

![](asserts/Pasted%20image%2020250522002022.png)

- 物理网卡当成网桥
- 另外一种
	- 多核，插槽只有一个。和核绑定。
![](asserts/Pasted%20image%2020250522002049.png)