...
![](asserts/Pasted%20image%2020250731155803.png)
...
就像[[_personal_avatar]](https://bingohuang.gitbooks.io/progit2/content/06-github/sections/4-managing-organization.html#_personal_avatar)，你可以为你的组织上传头像，使它更个性化。 同时，也和个人帐户类似，组织会有一个着陆页（landing page），用于列出该组织所有的版本库，并且该页面可供所有人浏览。
...
![](asserts/Pasted%20image%2020250731155856.png)
Figure 2. 组织页面

你可以点击 [组织页面](https://bingohuang.gitbooks.io/progit2/content/06-github/sections/4-managing-organization.html#_org_page) 右边的团队侧边栏（Teams）来管理你的团队。 点击之后，你会进入一个新页面，在这里你可以添加新成员和版本库到团队中，或者管理团队的访问权限和其它设置。 每个团队对于版本库可以有只读、读写和管理三种权限。 你可以通过点击在 [团队页面](https://bingohuang.gitbooks.io/progit2/content/06-github/sections/4-managing-organization.html#_team_page) 内的 “Settings” 按钮更改相应权限等级。
...
![](asserts/Pasted%20image%2020250731160007.png)
