...
### **IV**.原理层
- [DRY原则](../../../../../../basic/系统设计和架构/Area/设计模式/设计原则/DRY原则.md)
	- **代码复用**：一个copy函数适配所有实现了Read/Write的类型
...
- 与泛型密不可分
### 案例
![](https://raw.githubusercontent.com/Levio-z/MyPicture/main/img/20260121185543619.png)
...
- 后续卡片：
	...
	- trait分类
		...
		- [Rust-trait-泛型 Trait](trait分类/Rust-trait-泛型%20Trait.md)
		- [Rust-trait-带关联类型的 Trait](trait分类/Rust-trait-带关联类型的%20Trait.md)
			- [Rust-trait-关联泛型设计](misc/Rust-trait-关联泛型设计.md)
		- 
- 相似主题：
