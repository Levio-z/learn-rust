...
### 传染性
**只要链条中有一个异步点，整个链条都变成异步。** 详情见[Rust-future-组合设计的思想-基本概念](组合子/Rust-future-组合设计的思想-基本概念.md)
### 本质
...
```
- [Rust-future-源码-Output类型](源码/Rust-future-源码-Output类型.md)
- [Rust-future-源码-POLL方法](源码/Rust-future-源码-POLL方法.md)
- [Rust-future-源码-future包含什么](源码/Rust-future-源码-future包含什么.md)
- [Rust-future-理解future的简单源码](源码/Rust-future-理解future的简单源码.md)
- [Rust-future-源码-waker](源码/Rust-future-源码-waker.md)
...
- 后续卡片：
	...
	- [Rust-future-自定义一个简单future](实现/Rust-future-自定义一个简单future.md)
- 相似主题：
