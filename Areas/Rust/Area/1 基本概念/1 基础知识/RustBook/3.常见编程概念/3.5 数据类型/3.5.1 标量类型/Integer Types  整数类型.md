...
| **架构相关 (`arch`)** | `isize`      | 平台位宽决定：32位系统 → -2 147 483 648 ～ 2 147 483 64764位系统 → -9 223 372 036 854 775 808 ～ 9 223 372 036 854 775 807 | `usize`      | 平台位宽决定：32位系统 → 0 ～ 4 294 967 29564位系统 → 0 ～ 18 446 744 073 709 551 615 |
- 当符号重要时，数字会显示为加号或减号；
```rust
println!("{:+}", 42);   // 输出：+42
```
