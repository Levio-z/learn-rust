...
- 字符串去除尾部：[Rust-String-去除结尾特定内容的方法-toc](../../../../Areas/Rust/Area/3%20库&应用场景/库/标准库/alloc/String/methods/Rust-String-去除结尾特定内容的方法-toc.md)
- reqwest：[Rust-crate-reqwest-基本概念-TOC](../../../../Areas/Rust/Area/3%20库&应用场景/库/crate/reqwest/Rust-crate-reqwest-基本概念-TOC.md)
	- [Rust-Bytes-基本概念](../../../../Areas/Rust/Area/3%20库/库/crate/reqwest1/Rust-Bytes-基本概念.md)
- 切片和数组的git方法：
	- [Rust-slice 切片-get(..)](../../../../Areas/Rust/Area/3%20库&应用场景/库/标准库/std/slice/methods/Rust-slice%20切片-get(..).md)
	- [Rust-slice 切片-split_first_chunk-固定长度切割切片](../../../../Areas/Rust/Area/3%20库&应用场景/库/标准库/std/slice/methods/Rust-slice%20切片-split_first_chunk-固定长度切割切片.md)
- 链式处理：[Rust-Result-and_then](../../../../Areas/Rust/Area/3%20库&应用场景/库/标准库/std/option/Option/methods/Rust-Result-and_then.md)
- Cursor：[Rust-cursor-基本概念-TOC](../../../../Areas/Rust/Area/3%20库&应用场景/库/标准库/std/io/Cursor/Rust-cursor-基本概念-TOC.md)
- 缓冲读：[Rust-io-BufReader](../../../../Areas/Rust/Area/3%20库&应用场景/库/标准库/std/io/BufRead/Rust-io-BufReader.md)
- vec：[Rust-vec-try_into-将vec转换为数组](../../../../Areas/Rust/Area/3%20库&应用场景/库/标准库/alloc/Vec/Rust-vec-try_into-将vec转换为数组.md)
- fs
	- [Rust-fs-create_dir_all-递归创建目录](../../../../Areas/Rust/Area/3%20库&应用场景/库/标准库/std/fs/Rust-fs-create_dir_all-递归创建目录.md)
	- [Rust-fs-write-写入切片作为整个文件内容](../../../../Areas/Rust/Area/3%20库&应用场景/库/标准库/std/fs/Rust-fs-write-写入切片作为整个文件内容.md)
	- [Rust-path-PathBuf](../../../../Areas/Rust/Area/3%20库&应用场景/库/标准库/std/path/PathBuf/Rust-path-PathBuf.md) 一个非常好用的有所有权可以增删的路径对象
### 2 方案设计
### 2.1 基本方法
