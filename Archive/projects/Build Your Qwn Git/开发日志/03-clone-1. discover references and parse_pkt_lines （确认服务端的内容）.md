...
```
- 校验状态码Bytes
- 这里只得一提的是[Rust-Bytes-基本概念](../../../../Areas/Rust/Area/3%20库/库/crate/reqwest1/Rust-Bytes-基本概念.md)Byte可以直接当成切片用
...
- rust
	- [Rust-slice 切片-split_first_chunk-固定长度切割切片](../../../../Areas/Rust/Area/3%20库&应用场景/库/标准库/std/slice/methods/Rust-slice%20切片-split_first_chunk-固定长度切割切片.md)
	- [Rust-num-u16-from_str_radix](../../../../Areas/Rust/Area/3%20库&应用场景/库/标准库/core/num/Rust-num-u16-from_str_radix.md)
- 业务逻辑
	- [Git-gitprotocol-pack - 0-如何通过网络传输软件包](../notes/Git-智能协议/Git-gitprotocol-pack%20-%200-如何通过网络传输软件包.md)
